...
class ResidualDenseBlock(nn.Module):
    def __init__(self, in_channels):
        ...
        self.conv3 = nn.Conv2d(in_channels, in_channels, kernel_size=3, padding=1, bias=True)
        self.conv4 = nn.Conv2d(in_channels, in_channels, kernel_size=3, padding=1, bias=True)
        self.conv5 = nn.Conv2d(in_channels*5, in_channels, kernel_size=3, padding=1, bias=True)
